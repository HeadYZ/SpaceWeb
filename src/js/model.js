...
export const getDestinationInfo = selectedDestination => {
	const destinationInfo = destinationInformation.find(
		destination => destination.destination === selectedDestination.textContent
	)

	return [destinationInfo, destinationInfo.img]
}

export const getCrewInfo = selectedCrew => {
	const crewID = selectedCrew.dataset.id
	const activeCrew = crewInformation.find(crew => crew.id === crewID)
	return [activeCrew, activeCrew.img]
}
